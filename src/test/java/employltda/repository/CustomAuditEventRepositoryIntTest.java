package employltda.repository;

import employltda.EmployltdaApp;
import employltda.config.Constants;
import employltda.config.audit.AuditEventConverter;
import employltda.domain.PersistentAuditEvent;
...
import static employltda.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
